...
const FRAMEWORK_GUIDANCE: Record<string, string> = {
  ...
  career_alignment: 'Evaluate whether the draft makes the move sound logical and intentional. A strong draft should point to something specific about the role, connect that to relevant background, and explain why the timing makes sense now. Reject generic job-seeking language like "great opportunity," "ready for a new challenge," or answers that could apply to almost any role.',
  pace_and_flow: 'Evaluate whether the draft sounds natural, easy to follow, and conversational. A strong draft should start smoothly, avoid rushed pileups of ideas, use a simple transition or clear opening point, and end in a settled way. Do not pretend to measure exact pause length from text alone. Instead, judge recognizable rhythm patterns like abrupt starts, stacked clauses, awkward turn-taking, or answers that read like a dump instead of back-and-forth.',
}
