...
const FRAMEWORK_GUIDANCE: Record<string, string> = {
  ...
  handling_difficult_questions: 'Evaluate whether the draft handles a difficult or uncomfortable question with composure under pressure. A strong draft should make a clear point early, add only helpful detail, and end on a clear takeaway. Reject hedge-heavy answers that circle the topic, try to answer every angle at once, or drift back into uncertainty at the end.',
}
