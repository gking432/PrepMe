    ...
    <div className="flex min-h-[100dvh] items-center justify-center bg-[#f8fafc] px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-7">
          ...
          <p className="mt-1 text-sm text-slate-500">Continue your interview prep.</p>
          ...
          <p className="mt-5 text-center text-xs text-slate-500">
            New to PrepMe?{' '}
            <Link href="/auth/signup" className="font-semibold text-accent-600 hover:text-accent-700">Create an account</Link>
          </p>
        </div>
      </div>
    </div>
