...
function DashboardPageContent() {
  ...
  return (
    <AppChrome
      active="preps"
      maxWidth="max-w-7xl"
      headerMaxWidth={showWorkspaceHub ? 'max-w-7xl' : 'max-w-[948px]'}
      hideMobileTabs={!showWorkspaceHub}
    >
      <div>
        {showWorkspaceHub && (
        ...
        {onboardStep === 'stage' && (
          <div className="mx-auto flex w-full max-w-2xl flex-col gap-5 animate-slide-up">
            ...
            {/* Bundle unlock */}
            {!PORTFOLIO_DEMO_MODE && user && !TEST_ALL_INTERVIEW_STAGES_UNLOCKED && PAID_STAGES.some(s => isStageLockedFn(s)) && (
              <button
