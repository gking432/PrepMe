...
const CONFIGS: Record<WorkshopType, WorkshopConfig> = {
  star_proof: {
    ...
    steps: [
      { key: 'situation', label: 'Situation', description: 'Set the scene in 1-2 sentences. Who, where, when. Just enough to follow.', prompt: 'Pick a real situation.', color: 'sky', emoji: '🎬', example: '"[Name the setting, constraint, and why it mattered.]"' },
      { key: 'task', label: 'Task', description: 'What was specifically at stake or yours to own?', prompt: 'What was on your plate?', color: 'amber', emoji: '🎯', example: '"[State exactly what you personally owned.]"' },
      { key: 'action', label: 'Action', description: 'The biggest weight goes here. What did you actually do?', prompt: 'What did you actually do?', color: 'violet', emoji: '⚡', example: '"[Give two or three truthful actions you took.]"' },
      { key: 'result', label: 'Result', description: 'Close with what changed. Numbers if you have them, real outcome if you don\'t.', prompt: 'What changed?', color: 'emerald', emoji: '✅', example: '"[Describe the observable result or lesson.]"' },
    ],
    ...
    gatherQuestions: [
      { key: 'story_company', label: 'Where did this happen?', placeholder: 'Name the setting without using a real employer name.', hint: 'Describe the context without entering identifying details.' },
      { key: 'story_problem', label: 'What specifically went wrong or was at stake?', placeholder: 'Describe the specific problem, risk, or constraint.', hint: 'Name the actual problem, not the general responsibility.', multiline: true },
      { key: 'story_action', label: 'What did you actually do about it?', placeholder: 'Describe two or three actions you personally took.', hint: 'Concrete actions — what you personally did, not what the team did generally.', multiline: true },
      { key: 'story_result', label: 'How did it turn out?', placeholder: 'Describe the observable result or lesson.', hint: 'Numbers only if they are truthful and supported.' },
    ],
  },
  professional_story: {
    ...
    steps: [
      { key: 'present', label: 'Present', description: 'Where you are right now. Role, focus, what you\'re known for.', prompt: 'Start with your now.', color: 'violet', emoji: '👋', example: '"[Describe your professional lane now.]"' },
      { key: 'past', label: 'Past', description: 'The 1-2 things in your background that explain how you got here.', prompt: 'What shaped that?', color: 'sky', emoji: '🧭', example: '"[Select one relevant past experience that built that lane.]"' },
      { key: 'future', label: 'Future', description: 'Why this role is the natural next step.', prompt: 'Why this role next?', color: 'emerald', emoji: '🚀', example: '"[Explain why this specific role is the logical next step.]"' },
    ],
  ...
  career_alignment: {
    ...
    steps: [
      { key: 'observation', label: 'Observation', description: 'One specific thing about the role/team that stood out.', prompt: 'What did you notice?', color: 'amber', emoji: '🔍', example: '"[Name one specific responsibility or company detail.]"' },
      { key: 'fit', label: 'Fit', description: 'A concrete piece of your experience that maps to it.', prompt: 'How does it match you?', color: 'violet', emoji: '🧩', example: '"[Connect one truthful strength to that detail.]"' },
      { key: 'timing', label: 'Timing', description: 'Why now makes sense in your arc.', prompt: 'Why now?', color: 'emerald', emoji: '⏱️', example: '"[Explain why the move makes sense now.]"' },
    ],
  ...
  handling_uncertainty: {
    ...
    steps: [
      ...
      { key: 'example', label: 'Example', description: 'A real moment from your work that backs it up.', prompt: 'What backs it up?', color: 'emerald', emoji: '📌', example: '"[Add one truthful supporting moment, if available.]"' },
    ],
  ...
  pace_delivery: {
    ...
    steps: [
      { key: 'opener', label: 'Opener', description: 'Lead with the main point in one declarative sentence. No "so", no "um", no warmup.', prompt: 'What\'s the headline?', color: 'violet', emoji: '🎤', example: '"[State your main point directly.]"' },
      { key: 'main_point', label: 'Main Body', description: '2-3 sentences of clean support. Same content as before, no filler.', prompt: 'Add the supporting beats.', color: 'sky', emoji: '📣', example: '"[Support it with two concise, truthful details.]"' },
      { key: 'landing', label: 'Landing', description: 'Close cleanly. Don\'t trail off into "yeah, so, that\'s it".', prompt: 'How do you land it?', color: 'emerald', emoji: '🛬', example: '"[Close with the result or relevance.]"' },
    ],
  ...
  preparation_curiosity: {
    ...
    steps: [
      { key: 'what_you_know', label: 'What You Know', description: 'One real specific from the JD or company — not "I love your mission".', prompt: 'What\'s the real specific?', color: 'sky', emoji: '📚', example: '"[Name one verified detail from the role or company.]"' },
      { key: 'what_stood_out', label: 'What Stood Out', description: 'Why that one detail caught your attention.', prompt: 'Why did it catch you?', color: 'amber', emoji: '✨', example: '"[Explain why that detail matters to you.]"' },
      { key: 'your_question', label: 'Your Question', description: 'A question that follows naturally from the above — not a generic culture question.', prompt: 'What do you want to ask?', color: 'violet', emoji: '❓', example: '"[Ask a specific question about ownership, success, or collaboration.]"' },
    ],
  ...
  role_depth: {
    ...
    steps: [
      { key: 'context', label: 'Context', description: 'Name the real situation — what you were working on, what the constraints were, and why it mattered.', prompt: 'Set the real context.', color: 'sky', emoji: '🔬', example: '"[Name the situation, constraints, and stakes.]"' },
      { key: 'method', label: 'Method', description: 'What approach did you choose and why? Name the specific tools, frameworks, or thinking you applied.', prompt: 'What was your method?', color: 'violet', emoji: '🛠️', example: '"[Describe the approach you chose and why.]"' },
      { key: 'tradeoff', label: 'Tradeoff', description: 'What did you weigh? What did you decide against and why?', prompt: 'What did you trade off?', color: 'amber', emoji: '⚖️', example: '"[Explain the real tradeoff you weighed.]"' },
      { key: 'outcome', label: 'Outcome', description: 'What happened because of your approach? Be specific.', prompt: 'What was the result?', color: 'emerald', emoji: '📊', example: '"[State the observable outcome.]"' },
    ],
    ...
    gatherQuestions: [
      { key: 'story_company', label: 'Where did this happen?', placeholder: 'Name the setting without using a real employer name.', hint: 'Describe the context without identifying details.' },
      { key: 'story_problem', label: 'What was the real challenge or project?', placeholder: 'Describe the specific challenge or constraint.', hint: 'Name the challenge, not your general job duties.', multiline: true },
      { key: 'story_method', label: 'What approach did you take and why?', placeholder: 'Describe the approach you chose and your reasoning.', hint: 'What did you decide to do, and why?', multiline: true },
      { key: 'story_result', label: 'What happened because of your approach?', placeholder: 'Describe the observable outcome.', hint: 'Numbers only if they are truthful and supported.' },
    ],
  },
  problem_solving: {
    ...
    steps: [
      { key: 'clarify', label: 'Clarify', description: 'What did you need to understand first? What assumptions did you test or questions did you ask?', prompt: 'What did you clarify first?', color: 'sky', emoji: '🔎', example: '"[Name the first assumption or unknown you clarified.]"' },
      { key: 'approach', label: 'Approach', description: 'What was your plan? Name the options you considered and why you picked this path.', prompt: 'What was your approach?', color: 'violet', emoji: '🧭', example: '"[Describe the options you considered and the path you chose.]"' },
      { key: 'execute', label: 'Execute', description: 'What did you actually do? Concrete steps, not theory. Include who you worked with if relevant.', prompt: 'What did you do?', color: 'amber', emoji: '⚡', example: '"[List the concrete steps you personally took.]"' },
      { key: 'reflect', label: 'Reflect', description: 'What worked, what would you do differently, and what did you take away?', prompt: 'What would you change?', color: 'emerald', emoji: '💡', example: '"[State what worked and what you learned.]"' },
    ],
    ...
    gatherQuestions: [
      { key: 'story_company', label: 'Where did this happen?', placeholder: 'Name the setting without using a real employer name.', hint: 'Describe the context without identifying details.' },
      { key: 'story_problem', label: 'What was the problem you had to solve?', placeholder: 'Describe what was broken, unclear, or at risk.', hint: 'Name the actual problem, not a general responsibility.', multiline: true },
      { key: 'story_action', label: 'What did you actually do?', placeholder: 'Describe the concrete steps you personally took.', hint: 'Use your own actions, not the team\'s actions generally.', multiline: true },
      { key: 'story_result', label: 'How did it turn out?', placeholder: 'Describe what changed because of your actions.', hint: 'Use only truthful, supported outcomes.' },
    ],
  },
}
            ...
            <div className="workshop-intro-stack">
              <div className="workshop-intro-card border border-violet-100 bg-violet-50/60">
                <div className="flex items-start gap-3">
                  ...
                  <p className="workshop-intro-copy text-sm leading-7 text-slate-800">{config.whyBody}</p>
                </div>
              </div>
              ...
              <div className="workshop-intro-card border border-slate-200 bg-slate-50">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="workshop-intro-copy mt-1 text-sm leading-6 text-slate-800">{config.whenItHits}</p>
                  </div>
                </div>
              </div>
              ...
              {answerSummary && (
                <div className="workshop-intro-card border border-rose-100 bg-rose-50/50">
                  ...
                  <p className="workshop-intro-copy mt-2 text-sm italic leading-6 text-rose-900">&ldquo;{answerSummary}&rdquo;</p>
