        ...
        exercises: [
          {
            ...
            options: [
              'Whether you can speak positively and enthusiastically about the opportunity.',
              'Whether the move sounds specific, connected to your background, and logical right now.',
              'Whether you know enough company facts to prove you did research.',
              'Whether you can describe your long-term career goals in a polished way.',
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              'Start with why you want change, then explain why the role seems exciting.',
              'Use Observation, Fit, Timing to explain what stands out, why it connects to you, and why the move makes sense now.',
              'Focus on your strongest transferable skills and the value you could bring.',
              'Lead with growth and long-term goals so the interviewer sees ambition.',
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              'Show that you already understand the company’s history and market position.',
              'Point to something real about the role or opportunity that specifically stands out to you.',
              'Introduce your strongest background qualification before you explain fit.',
              'Show that you are serious by sounding formal and intentional at the beginning.',
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              'I’m interested because this seems like a great next step for me. I’m ready for something new, and I think the role would give me a chance to grow.',
              ...
              'I’m drawn to the role because I know it would challenge me and help me build new skills in a fast-paced environment.',
              'This role stood out because I’ve been wanting to find a company where I can contribute quickly and keep moving forward in my career.',
            ],
            correctIndex: 1,
            ...
            followUp: {
              ...
              explanation: 'A strong alignment answer sounds selected and logical. The interviewer can hear what stood out, why it fits, and why now.',
            },
          },
          {
            type: 'multiple_choice',
            ...
            options: [
              'The Observation is too specific.',
              'The Fit is too narrow.',
              'The Timing is weak and generic.',
              'The answer spends too much time on company praise.',
            ],
            correctIndex: 2,
          ...
          },
          {
            ...
            options: [
              'What stood out to me is that this seems like a great opportunity with a lot of room for growth.',
              'What stood out to me is that the role seems fast-paced and collaborative, which is the kind of environment I enjoy.',
              'What stood out to me is how central the role is to keeping cross-functional work aligned as priorities move.',
              'What stood out to me is that the company has a strong reputation and this looks like a meaningful next step.',
            ],
            correctIndex: 2,
          ...
          },
          {
            ...
            options: [
              'That fits my background because I know I have transferable skills that would help me succeed here.',
              ...
              'That fits me well because I’m confident I could grow into the role quickly.',
              'That aligns with my background because I’ve always been interested in this kind of work.',
            ],
            correctIndex: 1,
          ...
          },
          {
            ...
            options: [
              'I’m ready for something new, and this feels like a good next challenge for me.',
              ...
              'I’ve learned a lot where I am, and I think it’s time for me to keep growing.',
              'I wanted to start exploring roles where I could bring my skills into a new environment.',
            ],
            correctIndex: 1,
          ...
          {
            type: 'multiple_choice',
            title: 'Drill 9 - Chosen vs generic',
            question: 'Which answer sounds least like you would take almost any role right now?',
            options: [
              'I’m looking for a strong next opportunity where I can keep learning and growing.',
              'This feels like a logical move because it builds directly on the kind of work I’ve already been doing and moves me closer to the work I want to own more fully.',
              'I’m open to a range of roles, but this one stood out to me in particular.',
              'I’m excited by the chance to challenge myself in a new environment and bring value quickly.',
            ],
            correctIndex: 1,
            explanation: 'A stronger answer sounds chosen and coherent, not broadly open-ended.',
          },
          {
            type: 'apply_to_yourself',
