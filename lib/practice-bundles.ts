...
function buildAnswerStructureLesson(template: AnswerStructureTemplate): SubLesson {
  switch (template) {
    case 'present_past_why_here':
      return {
        title: 'Tell your story with substance',
        difficulty: 'easy',
        teach: {
          title: 'Use Present, Past, Why Here with real descriptors',
          explanation: 'Tell me about yourself is not just three buckets. Each bucket needs real substance. Present should name your current lane with enough specificity to sound real. Past should explain the through-line behind that lane. Why Here should connect your background to this exact role, not just to wanting a job.',
          example: {
            ...
            breakdown: {
              Present: 'Name your lane with a descriptor, not just a category.',
              Past: 'Explain the through-line that led you there.',
        ...
        exercises: [
          ...
          { type: 'multiple_choice', question: 'Which answer opening is strongest?', options: ['I have done a lot of different things over the years.', 'Right now I work in growth marketing, mostly focused on execution and analytics for cross-functional launches.', 'I can start from the very beginning if that is helpful.', 'My background is a little all over the place.'], correctIndex: 1, explanation: 'A strong opening gives a clean current snapshot with enough detail to sound real.' },
          { type: 'multiple_choice', question: 'What makes a "Present" line sound credible instead of generic?', options: ['It stays broad so it can fit many roles.', 'It names your current lane with a useful descriptor of focus, scope, or function.', 'It repeats your exact job title only.', 'It starts from your first job for context.'], correctIndex: 1, explanation: 'A strong Present line does more than name a category. It tells the interviewer what kind of work you actually do.' },
          ...
          { type: 'multiple_choice', question: 'Which "Past" line is strongest?', options: ['Before that, I had a lot of different experiences.', 'Before that, I worked in several roles across different companies.', 'Before that, I built my foundation in agency and in-house roles where I learned how to turn messy requests into clean execution.', 'Before that, I did a little bit of everything.'], correctIndex: 2, explanation: 'Strong Past lines explain the through-line behind your experience, not just that you had experience.' },
          ...
          { type: 'multiple_choice', question: 'What is the biggest mistake in a weak tell-me-about-yourself answer?', options: ['It is too structured', 'It gives no sense of current relevance and stays generic', 'It mentions your current role', 'It ends too clearly'], correctIndex: 1, explanation: 'Weak answers often sound like resume recitals with no clear point or specificity.' },
          ...
          { type: 'tap_select', instruction: 'Tap the moves that strengthen a tell-me-about-yourself answer.', items: ['Start with where you are now', 'Add one useful descriptor to make each section sound real', 'Walk through every job in order', 'Close by tying your story to the role'], correctIndices: [0, 1, 3], explanation: 'The strongest version is selective, specific, and role-relevant.' },
          {
            ...
            coachingTip: 'Keep it tight, but not generic. Each line should contain one useful descriptor. Your Present should name your lane, your Past should explain the through-line, and your Why Here should connect directly to this role.',
            evaluationType: 'present_past_why_here',
            fields: [
              { label: 'Present', placeholder: 'What do you do now, and what is your current focus?', helper: 'Give a clean current snapshot with one useful descriptor of your lane or scope.', minWords: 8, avoidWords: ['something', 'stuff', 'various things', 'a lot of things'] },
              { label: 'Past', placeholder: 'What relevant background led you here?', helper: 'Only include the past that explains your through-line.', minWords: 8, avoidWords: ['a lot of experience', 'different things', 'various roles'] },
              { label: 'Why Here', placeholder: 'Why does this role make sense as your next step now?', helper: 'Tie your story to this role directly, not just to getting a full-time job.', minWords: 10, avoidWords: ['full-time role', 'something new', 'good opportunity'] },
            ],
          },
        ],
      }
