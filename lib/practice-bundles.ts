...
export const PRACTICE_BUNDLES: PracticeBundle[] = [
  ...
  },
  {
    ...
    description: 'When the answer is not obvious right away, the goal is to stay calm, make one clear point, and respond in a grounded way.',
    lessons: [
      {
        title: 'Stay Grounded When You Are Unsure',
        difficulty: 'easy',
        teach: {
          title: 'Stay calm, make one point, and respond in a grounded way',
          explanation:
            'When the answer is not obvious right away, the goal is not to sound perfect. The goal is to stay calm, make one clear point, and respond in a way that feels honest and grounded.',
          example: {
            question: 'What would you do if you were asked to handle something and you were not fully sure of the right answer yet?',
            badAnswer:
              'I think there are probably a few ways to think about that, and it would really depend on the situation, and I would want to be careful not to do the wrong thing too quickly. There are a lot of factors there, so I think I would probably just try to feel it out first.',
            mediumAnswer:
              'I would want to understand the situation a little better first, but my starting point would be to clarify the issue directly before reacting.',
            goodAnswer:
              'I would want to get clear on the situation before reacting too quickly. My first step would be to understand what matters most and where the uncertainty actually is. The main thing is staying calm and making the next decision from something real, not from guesswork.',
            breakdown: {
              Steadiness: 'Do not fill the space with hedge-heavy rambling.',
              ClearPoint: 'Make one clear point early so the interviewer has something to follow.',
              HonestCaution: 'Be honest about what is unclear without sounding helpless.',
              FirstStep: 'Name the first useful move you would make.',
              GroundedEnding: 'End on a settled principle instead of drifting back into uncertainty.',
            },
            annotatedStrongAnswer: [
              {
                label: 'Clear Point',
                text: 'I would want to get clear on the situation before reacting too quickly.',
                detail: 'This gives a grounded starting point instead of circling or stalling.',
              },
              {
                label: 'First Step',
                text: 'My first step would be to understand what matters most and where the uncertainty actually is.',
                detail: 'This names a real move instead of vague caution or passive waiting.',
              },
              {
                label: 'Grounded Principle',
                text: 'The main thing is staying calm and making the next decision from something real, not from guesswork.',
                detail: 'This ending feels settled even though the full answer is not obvious yet.',
              },
            ],
          },
        },
        exercises: [
          {
            type: 'tap_select',
            instruction: 'Tap the parts of this answer that make it feel unsure in a weak way.',
            items: [
              'there are probably a few ways to think about that',
              'it would really depend on the situation',
              'I would want to be careful not to do the wrong thing too quickly',
              'There are a lot of factors there',
              'I would probably just try to feel it out first',
            ],
            correctIndices: [0, 1, 3, 4],
            explanation: 'These lines add uncertainty without adding direction. The answer keeps circling, but never says what the person would actually do.',
          },
          {
            type: 'multiple_choice',
            question: 'Which response handles uncertainty more credibly?',
            options: [
              'I would want to understand the situation a little better first, but my starting point would be to clarify the issue directly before reacting.',
              'I think there are a lot of ways it could go, and I would probably need more time to really know what I would do.',
            ],
            correctIndex: 0,
            explanation: 'Honest caution is fine when it still gives a first move. The weaker answer stays vague and never lands anywhere useful.',
          },
          {
            type: 'multiple_choice',
            question: 'Which opening gives the clearest starting point when you do not have a polished answer right away?',
            options: [
              'That is a really interesting question, and I think there are a lot of ways to look at it.',
              'The first thing I would want to do is understand the situation clearly before deciding how to handle it.',
              'It probably depends a lot on context, honestly.',
              'I have thought about things like that before, and there are a lot of variables.',
            ],
            correctIndex: 1,
            explanation: 'It starts with a real point and a first step instead of stalling.',
          },
          {
            type: 'multiple_choice',
            question: 'Which response does the best job of naming a useful first move?',
            options: [
              'I would try to stay calm and think about it.',
              'I would probably do my best and figure it out as I went.',
              'I would first get clear on what matters most in the situation so I could make a more grounded decision.',
              'I would not want to rush into anything.',
            ],
            correctIndex: 2,
            explanation: 'The first step shows judgment. The others stay broad, passive, or purely cautious.',
          },
          {
            type: 'apply_to_yourself',
            instruction: 'Rewrite this answer so it sounds calm, honest, and grounded. Keep it under 3 sentences.',
            coachingTip: 'Start with one clear point. Acknowledge uncertainty honestly. Name the first step you would take. End on the principle you would follow.',
            evaluationType: 'handling_uncertainty',
            fields: [
              {
                label: 'Main point',
                placeholder: 'What is the one clear point you want to make first?',
                helper: 'Start with something settled enough for the interviewer to follow.',
                minWords: 6,
                avoidWords: ['it depends', 'a lot of ways', 'every situation is different'],
              },
              {
                label: 'What is unclear?',
                placeholder: 'Acknowledge the uncertainty honestly without sounding helpless.',
                helper: 'Be honest, but do not just stall.',
                minWords: 8,
                avoidWords: ['I do not know', 'it could go a lot of ways', 'I would need way more time'],
              },
              {
                label: 'First step',
                placeholder: 'What first useful step would you take?',
                helper: 'Name the first move that would make the answer feel grounded.',
                minWords: 8,
                avoidWords: ['feel it out', 'do my best', 'see what happens'],
              },
              {
                label: 'Grounded takeaway',
                placeholder: 'What principle would you end on?',
                helper: 'Even if the full answer is not obvious yet, the ending should feel settled.',
                minWords: 6,
