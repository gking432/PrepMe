    ...
    case 'present_past_why_here':
      return {
        ...
        teach: {
          ...
          explanation: 'Tell me about yourself is not a life story. Start with a specific snapshot of where you are now, give the most relevant background that explains your through-line, then close on why this role makes sense as the next step. Generic labels alone are not enough. Each part needs concrete descriptors.',
          example: {
